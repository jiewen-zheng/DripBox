...
void usart0_init(uint32_t baud)
{
	...
	/* apply fifo */
	// fifo_register(&usart0_fifo, usart0_fifo_buff, sizeof(usart0_fifo_buff), NULL, NULL);
	if (!fifo_dynamic_register(0, 512))
	{
...
void usart0_idle_handle()
{
	if (RESET != usart_interrupt_flag_get(USART0, USART_INT_FLAG_IDLE))
	{
		...
		// FIFO
		fifo_dynamic_write(USART0_FIFO_NUM, (uint8_t *)usart0_rxbuf, read_len);
